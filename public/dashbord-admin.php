...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="bg-blue-500 text-white p-3">
        <ul class="flex space-x-4">
            <li><a href="#users-section" class="hover:underline">Gestion des utilisateurs</a></li>
            <li><a href="#courses-section" class="hover:underline">Gestion des cours</a></li>
            <li><a href="#categories-section" class="hover:underline">Gestion des catégories</a></li>
            <li><a href="#tags-section" class="hover:underline">Gestion des tags</a></li>
            <li><a href="#stats-section" class="hover:underline">Statistiques globales</a></li>
        </ul>
    </nav>
    ...
    <div>
        ...
        <h3 class="font-medium">Cours le plus populaire</h3>
        <p id="most-popular-course">
            <?php
            if (!empty($stats['most_popular_course'])) {
                echo "{$stats['most_popular_course']['title']} ({$stats['most_popular_course']['student_count']} étudiants inscrits)";
            } else {
                echo "Aucun cours populaire disponible.";
            }
            ?>
        </p>

        <h3 class="font-medium">Top 3 des enseignants</h3>
        <ol id="top-teachers" class="list-decimal pl-6">
            <?php
            if (!empty($stats['top_teachers'])) {
                foreach ($stats['top_teachers'] as $teacher) {
                    echo "<li>{$teacher['name']} - {$teacher['course_count']} cours</li>";
                }
            } else {
                echo "<li>Aucun enseignant trouvé.</li>";
            }
            ?>
        </ol>
    </div>
